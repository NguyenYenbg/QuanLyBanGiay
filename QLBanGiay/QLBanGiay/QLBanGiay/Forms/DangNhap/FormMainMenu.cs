...
namespace QLBanGiay
{
    public partial class FormMainMenu : Form
    {
        ...
        private void OpenChildForm(Form childForm)
        {
            ...
            childForm.TopLevel = false; //child Form not top-level
            childForm.FormBorderStyle = FormBorderStyle.None; //remove the edge
        ...
        private void Reset()
        {
            ...
            DisableButton();    //ẩn hiển thị các nút
            leftBorderBtn.Visible = false;  //ẩn viền của các nút
        }
        */
